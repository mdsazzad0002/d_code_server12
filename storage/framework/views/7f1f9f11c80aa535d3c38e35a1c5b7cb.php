...
<?php $__currentLoopData = $comments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $comment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    ?>
    <?php if( $ads_lavel && $i% $ads_lavel == 0): ?>
...
<?php $component->withAttributes([]); ?>
        <?php echo $__env->make('frontend.comment.helper.comment', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php /**PATH D:\wamp\www\GitHubDesktop\d_code_server12\resources\views/frontend/comment/helper/comment_format.blade.php ENDPATH**/ ?>