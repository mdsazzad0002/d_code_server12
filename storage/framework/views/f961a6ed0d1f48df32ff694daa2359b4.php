<ul class="nav nav-tabs">
    ...
    <li class="nav-item">
        <a class="nav-link d-flex align-items-center gap-2qq <?php echo e(Route::is('users.index', $user->username) ? 'active': ''); ?>" href="<?php echo e(route('users.index', $user->username)); ?>">
    ...
    <li class="nav-item d-none d-lg-block">
       ...
       <?php echo e(Route::is('users.post', $user->username) ? 'active': ''); ?>" href="<?php echo e(route('users.post', $user->username)); ?>"><i class="fa-solid fa-rss"></i>Posts <span class="badge bg-primary"><?php echo e($user->contribute->post ?? 0); ?></span></a>
        ...
        <li class="nav-item d-none d-xl-block">
            <a class="nav-link
           <?php echo e(Route::is('users.apply.job-post', $user->username) ? 'active': ''); ?>" href="<?php echo e(route('users.apply.job-post', $user->username)); ?>"><i class="fa-solid fa-toolbox"></i>Apply Job List</a>
        </li>
...
<?php /**PATH D:\wamp\www\GitHubDesktop\d_code_server12\resources\views/profile/layouts/partials/tab_menu.blade.php ENDPATH**/ ?>