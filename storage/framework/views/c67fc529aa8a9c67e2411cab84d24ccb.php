...
<script>
    ...
    var options = {
        ...
        title: {
          text: "<?php echo e($user->name); ?>'s Vote Contribute Rate",
          align: 'left'
        },
        grid: {
          borderColor: "#535A6C",
        ...
        xaxis: {
          categories: <?php echo e($vote_array_key); ?>,
          title: {
            text: 'Date'
          }
        },
...
<?php /**PATH D:\wamp\www\GitHubDesktop\d_code_server12\resources\views/profile/profile_partials/vote_report.blade.php ENDPATH**/ ?>