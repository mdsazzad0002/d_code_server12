<?php if(!empty($where) && general_setting('system_showup')=='on'): ?>
...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.frontend.card','data' => ['class' => ''.e($class ?? 'p-3').'']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
<?php $component->withAttributes(['class' => ''.e($class ?? 'p-3').'']); ?>
            <?php if(!empty(general_setting($where))): ?>
                <?php echo general_setting($where); ?>
...
<?php endif; ?>
<?php /**PATH D:\wamp\www\GitHubDesktop\d_code_server12\resources\views/components/frontend/ads.blade.php ENDPATH**/ ?>