                    ...
                    if (xhr.status === 200) {
                        ...
                        if(data_response.length > 0){
                            data_response.forEach((element)=>{
                                    ...
                                    data_format+=`
                                    <li class="">
                                        <a class="text-decoration-none" href="<?php echo e(url('post')); ?>/${element.slug.replace(/<[^>]+>/g, '')}">
...
<?php /**PATH D:\wamp\www\GitHubDesktop\d_code_server\resources\views/components/frontend/search_modal.blade.php ENDPATH**/ ?>