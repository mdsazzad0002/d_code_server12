        ...
        <div class="menu-inner">
            <nav>
                <ul class="metismenu" id="menu">
                    ...
                    <li class="{{ request()->routeIs('admin.job-post.index') ? 'active' : '' }}"><a
                                href="{{ route('admin.job-post.index') }}"><i class="ti-receipt"></i> <span>Job Post</span></a></li>
                            
                   <li class="{{ request()->routeIs('admin.apply-jobs.list') ? 'active' : '' }}"><a
                                    href="{{ route('admin.apply-jobs.list') }}"><i class="ti-receipt"></i> <span>Job Apply List</span></a></li>
        
                     <li class="{{ request()->routeIs('admin.report.index') ? 'active' : '' }}"><a
