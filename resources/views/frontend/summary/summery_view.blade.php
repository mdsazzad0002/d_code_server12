...
<div class="row">
    ...
    <a href="{{ route('users.index',$view_post?->users?->username ?? '#') }}" class=" col-12 col-sm-7 col-md-6  d-flex align-items-center  text-light" style="gap: 10px">
        <div>
            <img style="width: 60px; height:60px; border-radius:10%; object-fit:cover" class="lazy" data-src="{{dynamic_asset($view_post?->users?->uploads?->id)}}" alt="{{ $view_post?->tilte }}">
        </div>
        <div>
